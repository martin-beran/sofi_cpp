...
BOOST_AUTO_TEST_CASE(integrity_shared)
{
    ...
    BOOST_TEST(i0.value() == integrity_t::value_type{});
    integrity_t i1{internal_t{internal_t::set_t{"v1"}}};
    BOOST_TEST(i1.value() == integrity_t::value_type{internal_t::set_t{"v1"}});
    integrity_t i2{internal_t{internal_t::set_t{"v1", "v2"}}};
    BOOST_TEST((i2.value() == integrity_t::value_type{internal_t::set_t{"v1", "v2"}}));
    integrity_t i3{internal_t{internal_t::set_t{"v1", "v3", "v5"}}};
    BOOST_TEST((i3.value() == integrity_t::value_type{internal_t::set_t{"v1", "v3", "v5"}}));
    integrity_t i4{internal_t{internal_t::set_t{"v1", "v2", "v4"}}};
    BOOST_TEST((i4.value() == integrity_t::value_type{internal_t::set_t{"v1", "v2", "v4"}}));
    integrity_t i5{internal_t{internal_t::set_t{"v3", "v5"}}};
    BOOST_TEST((i5.value() == integrity_t::value_type{internal_t::set_t{"v3", "v5"}}));
    integrity_t i6{internal_t{internal_t::set_t{"v1", "v2", "v3", "v4", "v5"}}};
    BOOST_TEST((i6.value() == integrity_t::value_type{internal_t::set_t{"v1", "v2", "v3", "v4", "v5"}}));
    integrity_t i7{internal_t{internal_t::universe{}}};
    BOOST_TEST((i7.value() == integrity_t::value_type{internal_t::universe{}}));
    // conversion to string and output to stream
    BOOST_TEST(i0.to_string() == "{}");
    BOOST_TEST(i1.to_string() == "{v1}");
    BOOST_TEST(i2.to_string() == "{v1,v2}");
    ...
    BOOST_TEST(c == i2);
    BOOST_TEST(c != i4);
    BOOST_TEST(&c.value() == &i2.value());
    BOOST_TEST(&c.value() != &i4.value());
    c = i4;
    BOOST_TEST(c != i2);
    BOOST_TEST(c == i4);
    BOOST_TEST(&c.value() != &i2.value());
    BOOST_TEST(&c.value() == &i4.value());
    integrity_t m{std::move(c)};
    BOOST_TEST(m != i2);
    BOOST_TEST(m == i4);
    BOOST_TEST(&m.value() != &i2.value());
    BOOST_TEST(&m.value() == &i4.value());
    // comparison
    BOOST_TEST(i0 == i0);
    BOOST_TEST(i0 != i1);
    BOOST_TEST(i0 != i3);
    ...
    BOOST_TEST(integrity_t::max() == i7);
    BOOST_TEST(i0 + i0 == i0);
    BOOST_TEST(&(i0 + i0).value() == &i0.value());
    BOOST_TEST(i0 + i1 == i1);
    BOOST_TEST(&(i0 + i1).value() == &i1.value());
    BOOST_TEST(i0 + i2 == i2);
    BOOST_TEST(&(i0 + i2).value() == &i2.value());
    BOOST_TEST(i0 + i6 == i6);
    BOOST_TEST(&(i0 + i6).value() == &i6.value());
    BOOST_TEST(i0 + i7 == i7);
    BOOST_TEST(&(i0 + i7).value() == &i7.value());
    BOOST_TEST(i1 + i3 == i3);
    BOOST_TEST(&(i1 + i3).value() == &i3.value());
    BOOST_TEST(i1 + i5 == i3);
    BOOST_TEST(&(i1 + i5).value() != &i1.value());
    BOOST_TEST(&(i1 + i5).value() != &i5.value());
    BOOST_TEST(i3 + i4 == i6);
    BOOST_TEST(&(i3 + i4).value() != &i3.value());
    BOOST_TEST(&(i3 + i4).value() != &i4.value());
    BOOST_TEST(i6 + i4 == i6);
    BOOST_TEST(&(i6 + i4).value() == &i6.value());
    BOOST_TEST(i7 + i4 == i7);
    BOOST_TEST(&(i7 + i4).value() == &i7.value());
    BOOST_TEST(i7 + i7 == i7);
    BOOST_TEST(&(i7 + i7).value() == &i7.value());
    BOOST_TEST(i0 * i0 == i0);
    BOOST_TEST(&(i0 * i0).value() == &i0.value());
    BOOST_TEST(i0 * i1 == i0);
    BOOST_TEST(&(i0 * i1).value() == &i0.value());
    BOOST_TEST(i0 * i2 == i0);
    BOOST_TEST(&(i0 * i2).value() == &i0.value());
    BOOST_TEST(i0 * i6 == i0);
    BOOST_TEST(&(i0 * i6).value() == &i0.value());
    BOOST_TEST(i0 * i7 == i0);
    BOOST_TEST(&(i0 * i7).value() == &i0.value());
    BOOST_TEST(i1 * i3 == i1);
    BOOST_TEST(&(i1 * i3).value() == &i1.value());
    BOOST_TEST(i4 * i5 == i0);
    BOOST_TEST(&(i4 * i5).value() != &i4.value());
    BOOST_TEST(&(i4 * i5).value() != &i5.value());
    BOOST_TEST(i3 * i4 == i1);
    BOOST_TEST(&(i3 * i4).value() != &i3.value());
    BOOST_TEST(&(i3 * i4).value() != &i4.value());
    BOOST_TEST(i6 * i4 == i4);
    BOOST_TEST(&(i6 * i4).value() == &i4.value());
    BOOST_TEST(i7 * i4 == i4);
    BOOST_TEST(&(i7 * i4).value() == &i4.value());
    BOOST_TEST(i7 * i7 == i7);
    BOOST_TEST(&(i7 * i7).value() == &i7.value());
}
//! \endcond
